...
export function MedicalSurveillanceEnhanced({
  ...
  const sites = [
    "All Sites",
    ...Array.from(new Set(medicalRecords.map((r) => r.site))).sort(),
  ];
  ...
  const filteredRecords = medicalRecords.filter((record) => {
    ...
    const matchesSite =
      selectedSite === "All Sites" || record.site === selectedSite;
    ...
    switch (type) {
      case "pre-placement":
        return {
          ...
          bgColor: "var(--brand-blue)15",
        };
      case "periodic":
        return {
          label: "Periodic (Annual)",
          color: "var(--grey-700)",
  ...
  const fitCount = filteredRecords.filter(
    (r) => r.fitnessStatus === "fit",
  ).length;
  const restrictedCount = filteredRecords.filter(
    (r) => r.fitnessStatus === "fit-with-restrictions",
  ).length;
  const unfitCount = filteredRecords.filter(
    (r) => r.fitnessStatus === "unfit",
  ).length;
      ...
      <div className="max-w-[1600px] mx-auto">
            ...
            <div className="px-8 pt-6 pb-8">
              ...
              <div className="flex items-center gap-3">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setSelectedFitness(e.target.value as FitnessFilter)
                  }
                  className="px-4 py-2 rounded-lg border text-sm"
                  style={{
                    backgroundColor: "white",
                ...
                >
                  ...
                  <option value="fit-with-restrictions">
              ...
              <table className="border-collapse">
                ...
                <tbody>
                  {filteredRecords.map((record) => {
                    ...
                    const fitnessBadge = getFitnessStatusBadge(
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs" style={{ color: "var(--grey-600)" }}>
              Records in this module are legally archived for{" "}
              <strong>40 years</strong> as per OHS Act requirements.
            </span>
            <button
                  ...
                  >
                    ...
                    <div className="space-y-4 mb-6">
                      ...
                      <div>
                        ...
                        >
                          ...
                          {selectedRecord.practitionerType})
                        </p>
                      </div>
                    </div>
                    ...
                    >
                      <p
                        ...
                        style={{ color: "var(--grey-500)" }}
                      >
                        This certificate confirms the employee's fitness for the
                        specified work as assessed on the examination date.
                        <br />
                        This is a public document available to auditors and
                        management.
                      </p>
                    </div>
                  </div>
              ...
              >
                <div
                  ...
                  style={{
                    ...
                    borderColor: "var(--compliance-danger)",
                  }}
                >
                  <div className="flex items-center gap-3">
                    <EyeOff
                ...
                <div className="flex-1 overflow-y-auto p-6">
                        ...
                        <div className="grid grid-cols-2 gap-3 text-sm">
                          ...
                          <div className="col-span-2">
                            <p
                              ...
                              style={{ color: "var(--grey-500)" }}
                            >
                              Result: Normal hearing threshold. No significant
                              loss detected.
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-3 text-sm">
                          ...
                          <div className="col-span-2">
                            <p
                              ...
                              style={{ color: "var(--grey-500)" }}
                            >
                              Result: Normal lung function. No restrictive or
                  ...
                  <div className="mb-6">
                    ...
                    >
                      <p
                        ...
                        style={{ color: "var(--grey-700)" }}
                      >
                        <strong>Assessment:</strong> Employee presents in good
                        general health. All clinical assessments within normal
                        parameters for age and occupation.
                      </p>
                      <p
                        className="text-sm"
                        style={{ color: "var(--grey-700)" }}
                      >
                        <strong>Recommendation:</strong> Certified fit for
                        current duties without restrictions. Routine annual
                  ...
                  <div
                    ...
                    style={{
                      backgroundColor: "var(--compliance-danger)05",
                      borderColor: "var(--compliance-danger)",
                    }}
                  >
                    <p
                    ...
                    <p
                      ...
                      style={{ color: "var(--grey-600)" }}
                    >
                      This clinical information is confidential and protected
                      under the Protection of Personal Information Act (POPI).
                      Access is restricted to authorized medical personnel and
                      RSS administrators only. Unauthorized disclosure may
        ...
        {showRetentionInfo && (
          <>
            <div
              className="fixed inset-0 bg-black bg-opacity-50 z-40"
              onClick={() => setShowRetentionInfo(false)}
            />
            <div className="fixed inset-0 flex items-center justify-center z-50 p-8">
              <div
              ...
              >
                ...
                <div className="p-6">
                  <p
                    ...
                    style={{ color: "var(--grey-700)" }}
                  >
                    <strong>Legal Requirement:</strong> Under the Occupational
                    Health and Safety Act (OHS Act, 1993), Section 43, all
                    medical surveillance records must be retained for a period
                    of <strong>40 years</strong> from the date of the last
                    medical examination.
                  </p>
                  ...
                  >
                    ...
                    >
                      <li>
                        • Occupational diseases often have long latency periods
                      </li>
                      <li>• Enables long-term health trend analysis</li>
                      <li>
                        • Supports compensation claims for work-related
                        illnesses
                      </li>
                      <li>
                        • Provides historical baseline for medical conditions
                      </li>
                    </ul>
                  </div>

                  <p className="text-sm" style={{ color: "var(--grey-600)" }}>
                    SHERQ Online automatically archives all medical records in
                    compliance with this requirement. Records are securely
                    stored and never permanently deleted, even when employees
